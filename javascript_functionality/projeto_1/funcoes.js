...
function removerSerVazio(array) {
...
function removerSimbulos(simbolos) {
    return function (array) {
        return array.map(el => {
...
function ordernarPorAtriNumericos(attr, ordem = 'ascn') {
    return function (array) {
        const ascn = (o1, o2) => o1[attr] - o2[attr]
        const desc = (o1, o2) => o2[attr] - o1[attr]
        return [...array].sort(ordem === 'ascn' ? ascn : desc)
    }
}
